                ...
                <form class="user" method="POST" action="{{ route('password.process') }}">
                    ...
                    <div class="form-group">
                        <input type="password" id="passwordOld" name="passwordOld"
                            ...
                            placeholder="Enter Old Password..." value="{{ old('passwordOld') }}" required autocomplete="off"
                            autofocus>
                    ...
                    <div class="form-group">
                        <input type="password" id="passwordNew" name="passwordNew"
                            ...
                            placeholder="Enter New Password..." value="{{ old('passwordNew') }}" required autocomplete="off"
                            autofocus>
